...
(function(root, name, factory) {
    ...
    if (!root.jex)
        throw "requires jex to register";
    root.jex.register(name, ['funk'], factory);

}(this, 'kluje', function(funk) {
    
    var names = (
    'all argarray assign cons contains each existy filter first isarray isboolean ' + 
    ...
    function(all, argarray, assign, cons, contains, each, existy, filter, first, isarray, isboolean, 
    iscoll, isempty, isfunction, isobject, isstring, keys, length, map, pick, reduce, rest, 
    startswith, unzip, values, zipobject) {
